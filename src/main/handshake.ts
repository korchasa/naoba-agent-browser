 ...
 *
 * The file names the port and the token of the running copy, and nothing else.
 * It sits in the state directory, so the release copy, the development copy and
 * a checkout each have one of their own and a bridge that finds this copy's
 * file cannot talk to another copy with it. Mode 0600: the token is the whole
 * reason the port is not open to everything on the machine.
 *
