...
/**
 * Where an MCP server learns how to reach this copy of the application.
 *
 ...
 * checkout each have one of their own and an MCP server that finds this copy's file
 ...
 * file behind, still naming a port another copy may take next. An MCP server that
 * believed it would present a dead copy's token and be turned away.
 *
 * `packages/mcp-server/handshake.mjs` is the other half of this, and the file name
